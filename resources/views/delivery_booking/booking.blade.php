    ...
    <main class="container mt-3">
        ...
        <form action="{{route('booking')}}" method="POST">
            ...
            <div class="text-center mt-4">
                <button type="submit" class="btn btn-info btn-lg">Complete Booking</button>
            </div>
    </form>
...
@section('script')
        ...
        <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function(dataResult)
                    {
                        ...
                        var add_deliveryman ='<div id ="" class="form-group">' +
                            ...
                            '<select id="combo" name="delivery_man" class="custom-select text-center deliveryman">' +
            ...
            //select date
            var date = '<div id ="" class="form-group">' +
                '<label class="form-label">Select Date</label>'+
                '<div class="input-group date" >'+
                    '<input type="date" class="form-control text-center" name="date" value="">'+
                '</div>'+
            ...
            //select tiem slot
            var slot = '<div id ="" class="form-group">' +
                ...
                '<select name="slot" class="custom-select  text-center">' +
                    <?php
                                ...
                                for($i=1;$i<15;$i++){
                                    ...
                                    ?>
                                    '<option value="{{$previous_time}} to {{$startTime}}">{{$previous_time}} to {{$startTime}}</option>'+
                                <?php
                                    }
                            ?>
