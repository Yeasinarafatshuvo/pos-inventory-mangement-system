            ...
            <div class="card-header row gutters-5">
                ...
                <div class="col-md-2">
                    <div class="input-group">
                        <input type="text" class="form-control form-control-sm" onkeyup="search_product(this.value)" id="search" name="search"
                    ...
                    @foreach ($products as $key => $product)
                        <tr>
                            ...
                            <td class="text-right">
                                ...
                                <a class="btn btn-soft-info btn-icon btn-circle btn-sm"
                                    href="{{ route('product.barcode', ['id' => $product->id, 'lang' => env('DEFAULT_LANGUAGE')]) }}"
        ...
        function search_product(search_item=""){
            if(search_item == ""){
                search_item='codered';
                    $.ajax({
                    type:'get',
                    url:'product/product_search/'+search_item,
                    data:"",
                    cache:false,
