                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="product_warranty" value="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="no_product_variant">
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Stock Quantity') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="test" placeholder="Stock Quantity" name="stock_quantity"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="key_feature"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Random Search Key') }}</label>
                            <div class="col-md-8">
                                <textarea class="form-control" col="8" name="random_search" placeholder="laptop,leptop"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
