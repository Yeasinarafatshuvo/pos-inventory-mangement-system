            ...
            <div class="col-lg">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Product Warranty') }}</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="product_warranty" value="{{$product->product_warranty}}">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="no_product_variant" @if ($product->is_variant) style="display:none;" @endif>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Purchase Price') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="number" step="0.01" min="0" value="{{ $product->purchase_price }}"
                            ...
                            @can('dealer_price')
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Dealer Price') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="number" step="0.01" min="0" value="{{ $product->dealer_price }}"
                                        placeholder="{{ translate('Dealer Price') }}" name="dealer_price" class="form-control"
                                        required>
                                </div>
                            </div>
                            @endcan 
                            @can('corporate_price')
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Corporate Price') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="number" step="0.01" min="0" value="{{ $product->corporate_price }}"
                                        placeholder="{{ translate('Corporate Price') }}" name="corporate_price" class="form-control"
                                        required>
                                </div>
                            </div>
                            @endcan
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Stock Quantity') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="test" value="{{ $product->stock_quantity }}" placeholder="Stock Quantity" name="stock_quantity"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="key_feature">{{$product->key_feature}}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Random Search Key') }}</label>
                            <div class="col-md-8">
                                <textarea class="form-control" col="8" name="random_search" placeholder="laptop,leptop">@php if(!empty($product->random_search)){$random_search = json_decode($product->random_search);$i=1;foreach($random_search as $rs){ if(count($random_search) !== $i){echo $rs.",";}else{echo $rs;} $i++;} } @endphp</textarea>
                            </div>
                        </div>                        
                    </div>
                </div>
