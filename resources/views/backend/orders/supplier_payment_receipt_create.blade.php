...
<div class="card">
    <div class="card-body">
        <div class="card-title">
            <h4 class="text-center m-auto bg-primary text-white" style="text-decoration: underline;">Create Money Payment</h4>
        </div>
            <div class="m-auto">
                <form action="{{route('orders.purchase_order.supplier_payment_receipt_store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12 offset-md-2">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="maakview_account_name" required  class="form-control" id="total_payment" value="">
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-2 col-form-label pl-4 font-weight-bold" style="font-size: 15px">
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="maakview_checque_number" required  class="form-control" value="" >
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-2 col-form-label pl-4 font-weight-bold" style="font-size: 15px">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="maakview_cheque_date"  id="datepicker"  class="form-control" value="" >
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-2 col-form-label pl-4 font-weight-bold" style="font-size: 15px">
