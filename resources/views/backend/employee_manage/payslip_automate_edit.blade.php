...
<div class="container">
    ...
    <form action="{{route('payslip.update',['user_id' => $single_employee_payslip_data->automated_user_id, 'year' => $single_employee_payslip_data->attendance_year,'month' =>$single_employee_payslip_data->attendance_month])}}" method="POST">
      @csrf
          ...
          <table class="table table-bordered" style="border: 2px solid black !important;">
              ...
              <tbody>
                <tr>
                  ...
                  <td><input type="number" id="provident_fund" name="provident_fund" value="{{$single_employee_payslip_data->provident_fund}}" class="form-control form-control-sm text-center"></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>Absence</td>
                  <td><input type="number" value="{{$single_employee_payslip_data->absence}}" id="absence" name="absence" class="form-control form-control-sm text-center"></td>
                </tr>
                <tr>
                  <td>Transport Allowance (Gross Salary 10%)</td>
                  <td class="text-center">{{round($current_month_employee_salary * 0.10)}}</td>
                  <td>Loan Adjust</td>
                  <td><input type="number" id="loan_adjust" name="loan_adjust" value="{{$single_employee_payslip_data->loan_adjust}}" class="form-control form-control-sm text-center"></td>
                </tr>
                <tr>
                  <td>Mobile Allowance</td>
                  <td><input type="number" id="mobile_allowance" name="mobile_allowance" value="{{$single_employee_payslip_data->mobile_allowance}}" class="form-control form-control-sm text-center"></td>
                  <td>Advance Adjust</td>
                  <td><input type="number" id="advance_adjust" name="advance_adjust" value="{{$single_employee_payslip_data->advance_adjust}}" class="form-control form-control-sm text-center"></td>
                </tr>
                <tr>
                  <td>Lunch Allowance</td>
                  <td><input type="number" id="lunch_allowance" name="lunch_allowance" value="{{$single_employee_payslip_data->lunch_allowance}}" class="form-control form-control-sm text-center"></td>
                  <td></td>
                  <td></td>
                </tr>
                <tr>
                  <td>Festival Allowance</td>
                  <td><input type="number" id="festibal_allowance" name="festibal_allowance" value="{{$single_employee_payslip_data->festibal_allowance}}" class="form-control form-control-sm text-center"></td>
                  <td></td>
                  <td></td>
                </tr>
                <tr>
                  <td>Other's Allowances</td>
                  <td><input type="number" id="other_allowance" name="other_allowance" value="{{$single_employee_payslip_data->other_allowance}}" class="form-control form-control-sm text-center"></td>
                  <td></td>
                  <td></td>
                </tr>
                <tr>
                  ...
                  <input type="hidden" name="attendance_year" value="{{$single_employee_payslip_data->attendance_year}}">
                  <input type="hidden" name="attendance_month" value="{{$single_employee_payslip_data->attendance_month}}">
                  <input type="hidden" id="total_earnings_value" name="total_earnings_value" value="{{$single_employee_payslip_data->total_earnings_value}}">
                  <td id="total_earnings" class="text-center">
                    {{$single_employee_payslip_data->total_earnings_value}}
                  </td>
                  <td>Total Deductions</td>
                  <input type="hidden" id="total_deduction" name="total_deduction" value="{{$single_employee_payslip_data->total_deduction}}" class="form-control form-control-sm text-center">
                  <td id="total_deduction_amount" class="text-center"></td>
                </tr>
                <tr>
                  <td colspan="3">Net Pay</td>
                  <input type="hidden" id="total_net_pay" name="total_net_pay" value="{{$single_employee_payslip_data->total_net_pay}}">
                  <td id="net_pay"></td>
                </tr>
              </tbody>
            </table>
            <div class="payment_method">
              <div class="form-group">
                ...
                <select class="form-control" id="paymentMethod" name="paymentMethod" onchange="togglePaymentOption()">
                  <option value="cash" <?php if ($single_employee_payslip_data->paymentMethod == 'cash') echo 'selected'; ?>>By cash</option>
                  <option value="check" <?php if ($single_employee_payslip_data->paymentMethod == 'check') echo 'selected'; ?>>By check</option>
                </select>
              </div>
            </div>
            <input type="text" class="form-control" value="{{ $single_employee_payslip_data->check_details ?? '' }}" id="check_details" name="check_details" placeholder="Enter check details" style="{{ $single_employee_payslip_data->paymentMethod == 'check' ? '' : 'display: none' }}">
   
      </div>
      <button type="submit" class="btn btn-primary text-center" style="margin-left: 50%">Update</button>
    </form>  
</div>
