...
<body>
    ...
    <div style="margin-top:0px;">
        <div style="float: left;width:57%">
            @if ($order->payment_status == 'unpaid' && $order->print_payment_img_show == 'cash_on_delivery')
                <div class="mt-5">
            ...
            @else
                ...
                <div class="mt-5">
                        <img src="{{ static_asset('assets/img/payment_due.png') }}">
                </div>
    ...
    <footer class="footer" style="  width: 100%;text-align: center;">
        <p style="border-top: 1px solid black; padding-bottom:0px;padding-top:10px; margin-bottom:0px; text-align:justify;font-size:15px;line-height:15px">
        ...
        <p style="padding-bottom: 0px;margin-bottom:0px; text-align:justify;font-size:15px;line-height:15px">
        ...
        <p style="margin-bottom: 0px; padding-bottom:0px; text-align:justify;font-size:15px;line-height:15px">
