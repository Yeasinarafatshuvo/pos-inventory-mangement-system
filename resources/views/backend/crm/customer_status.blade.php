...
<div class="row">
    <div class="col-md-8 offset-md-2">
        ...
        <div class="container">
            <h2 class="bg-primary text-center text-white">Customer Feedback Status</h2>
            <form action="{{route('customer_marketing_crm.add_status_store', $client_id)}}" method="POST">
                @csrf
                <input type="hidden" name="customer_id" value="{{$client_id}}">
                <div class="form-group">
                    <label for="selectcustomer_status" class="pt-3" style="font-size: 20px">Feedback Status</label>
                    <select name="feedback_status" class="form-control" id="selectcustomer_status">
                ...
                <div class="form-group">
                    <label for="" style="font-size: 20px">Enter Customer Feedback Details</label>
                    <textarea class="form-control" name="feedback_details" id="customer_feedback"  cols="30" rows="10"></textarea>
                </div>
                ...
                <button disabled class="btn btn-primary" id="submit_feedback" style="width: 100%; font-size:20px">Submit Customer Feedback</button>
            </form>
        </div>
...
$("#select_product").keyup(function(){
    ...
    $('#selectcustomer_status').change(function (e) { 
        e.preventDefault();
        var customer_type = this.value;
        if(customer_type != "" || $feedback_value != ""){
    ...
    $("#customer_feedback").mouseleave(function(){
        var customer_feedback = this.value;
